            ...
            <form onSubmit={step === 1 ? handleNext : handleSubmit} className="space-y-4">
              {step === 1 ? (
                <div className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-black text-white py-3 rounded-full hover:bg-gray-800 transition-colors font-helvetica"
                  >
                    Next
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex space-x-4">
                    <button
                      type="button"
                      onClick={() => setStep(1)}
                      className="flex-1 border border-gray-300 text-gray-700 py-3 rounded-full hover:bg-gray-50 transition-colors font-helvetica"
                    >
                      Back
                    </button>
                    <button
                      ...
                      className="flex-1 bg-black text-white py-3 rounded-full hover:bg-gray-800 transition-colors font-helvetica disabled:opacity-50"
                    >
